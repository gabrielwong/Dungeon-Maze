...
public class Door extends MapObject implements Serializable {
	private boolean isClosed = true; // whether or not you can pass through a door
	...
	public Door(int x, int y) { // similar to a wall
		super(x, y);
	}
	...
	public void setVertical(boolean isVertical) { // set characteristics
